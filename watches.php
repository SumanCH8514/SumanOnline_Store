...
<html>
    <head>
        ...
        <title>Watches > SumanOnline Shop</title>
        <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="https://m.media-amazon.com/images/I/61RPXclW5KL._SX679_.jpg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Titan Edge Ceramic Watch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="https://m.media-amazon.com/images/I/61bMavETkyL._SX679_.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Titan Edge Quartz Watch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="https://m.media-amazon.com/images/I/61SyrIcnjBL._SX679_.jpg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Titan Classique Slimline Watch</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="https://m.media-amazon.com/images/I/61+1wEBKjiL._SX679_.jpg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Titan Edge Quartz Watch</h3>
